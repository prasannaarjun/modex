...
describe('BookingService Unit Tests', () => {
    ...
    it('should create a booking and schedule expiry job', async () => {
        ...
        // Act
        const result = await bookingService.createBooking(100, 1, [10, 11]);

        // Assert
        expect(mockCreateBooking).toHaveBeenCalledWith(100, 1, [10, 11]);
    ...
    it('should propagate errors from repository', async () => {
        ...
        // Act & Assert
        await expect(bookingService.createBooking(100, 1, [10, 11])).rejects.toThrow('No seats available');
